...
<div id="content">
	<div id="colOne">
        <h2> Opret en ny tag</h2>
            <p> På denne side kan du oprette en ny tag, der vises på forsiden.</p>
            <div id="opret">
                <form method="post" action="../food/DB/NewTag_DB.php">
                    <p>
                        <label><h3>Navn</h3></label><br />
                        <input name="TagName" type="text" size="50" maxlength="50" /> <br /><br />
