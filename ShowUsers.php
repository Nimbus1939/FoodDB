...
$Qusers = "Select * FROM Users ORDER BY UserAlias DESC";
...
<div id="content">
    <div id="colOne">
        <h2>Vis alle brugere</h2>
        <p>På denne side får du vist alle brugere.<br /> Klik på en bruger for at se brugerens oplysninger</p>
		<?php
			echo "<ul>";
            while($row = mysqli_fetch_assoc($users)) //En while der kører alle rækker igennem
            {
            echo "<LI> <a href=\"ShowUser.php?UserID=".$row['UserID']."\">".$row['UserAlias']."</a></LI>\n";
            }
			echo "</ul>";
        ?>
	</div>
