...
$link = OpenDB();
$QqueryKategori = "Select * FROM Kategori ORDER BY KategoriID DESC";
...
<div id="content">
	<div id="colOne">
        <h2> Rediger kategori</h2>
            <p>På denne side kan du vælge en kategori som skal redigeres.</p>
            <p>Vælg en kategori herunder, for at redigere den</p>
			<?php
			echo"<ul>";
			while($rowKategori = mysqli_fetch_assoc($queryKategori)) //En while der kører alle rækker igennem
			{
				echo "<LI><A href=\"../food/EditKategori.php?KategoriID=".$rowKategori['KategoriID']."\">".$rowKategori['KategoriName']."</a></LI>\n";
			}
			echo"</ul>";
			?>
	</div>
