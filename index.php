...
<div id="content">
    <div id="colOne">
        <h2>Velkommen til Mettes Opskrifter</h2><br/>
			<?php
				$i=0; // tællevariable
				while(($rowpost = mysqli_fetch_assoc($post)) && ($i++<=2)) //En while der kører alle rækker igennem, dog maks 3
				{
					echo "<div class=\"post\">\n\t\t\t";
					echo "<h2 class=\"title\">".$rowpost['Header'] . "</h2>\n\t\t\t";
					echo "<p class=\"meta\">Oprettet: " . $rowpost['CreateDate']."</p>\n\t\t\t";
					echo $rowpost['Content'];
					echo "<br/>\n\t\t\t";
					if ($rowpost['Link'] != NULL) // hvis Link er NULL renderes link linien ikke ud
						{
							echo "<a href=\"".$rowpost['Link']."\" target=\"_blank\" class=\"PostLink\">". $rowpost['LinkText']."</a><br/><br/>\n\t\t\t";
						}
					echo "<br></div>\n";
				}
			?>
            <p><a href="ShowAllPosts.php">Vis alle posts...</a></p>
    </div>
	<div id="colTwo">
		<ul>
			<li>
