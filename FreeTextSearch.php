...
<div id="content">
    <div id="colOne">
        <h2>Fritekstsøgning i indholdsfeltet</h2><br/>
        <p>På denne side kan du søge efter fritekst i alle opskrifter, kommentarer og ratings</p>
        <form action="ShowFreeTextResult.php" method="post" enctype="application/x-www-form-urlencoded" name="FreeText">
        <label>Søgetekst</label><br />
        <input name="SearchText" type="text" size="25" /><br />
        <label>Søg i:</label><br />
        <input name="Content" type="checkbox" value="Content" />Indhold<br />
        <input name="Kommentar" type="checkbox" value="Kommentar" />Kommentarer<br />
        <input name="Rating" type="checkbox" value="Rating" />Ratings<br /><br />
