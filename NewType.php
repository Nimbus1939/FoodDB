...
<div id="content">
    	<div id="colOne">
        <h2> Opret en ny type</h2>
            <p> På denne side kan du oprette en ny type, der vises på forsiden.</p>
            <div id="opret">
                <form method="post" action="../food/DB/NewType_DB.php">
                    <p>
                        <label><h3>Navn</h3></label><br />
                        <input name="TypeName" type="text" size="50" maxlength="50" /> <br /><br />
