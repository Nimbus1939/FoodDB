...
$QqueryPlaceholder = "Select * FROM Placeholders";
...
$queryPlaceholder = mysqli_query($link, $QqueryPlaceholder);
?>
...
<div id="content">
    <div id="colOne">
        <?php
			echo "<h2>Vælg placering</h2>\n";
			echo "<p>På denne side kan du vælge hvilken placerings holder du vil omrokere elementerne i</p>\n<ul>";
			while($rowPlaceholder = mysqli_fetch_assoc($queryPlaceholder)) //En while der kører alle rækker igennem
				{
				echo "<li><a href=\"SortOrderEdit.php?Placeholder=".$rowPlaceholder['Placeholder']."\">".$rowPlaceholder['Placeholder']."</a></li>\n";
				}
			echo"</ul>\n";
		?>
    </div>
