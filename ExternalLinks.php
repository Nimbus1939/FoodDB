...
<div id="content">
	<div id="colOne">
        <h2>Eksterne links</h2>
            <p>På denne side vises alle eksterne links<br />Hvis du vil oprette et eksternt link kan du gøre det <a href="../food/NewLink.php"> HER </a> <br />Husk at vælge placeholder External, og om linket skal åbnes i et nyt vindue.</p>
			<?php
			echo"<ul>";
			$query = mysqli_query($link, "Select * FROM Links WHERE Placeholder='External' ORDER BY LinkID DESC");
