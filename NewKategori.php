...
<title>Opret en ny kategori</title>
</head>
<body>
<div id="title">
...
<div id="content">
    <div id="colOne">
        <h2> Opret en ny kategori</h2>
            <p> På denne side kan du oprette en ny kategori, der vises på forsiden.</p>
            <div id="opret">
                <form method="post" action="../food/DB/NewKategori_DB.php">
                    <p>
                        <label><h3>Navn</h3></label><br />
                        <input name="KategoriName" type="text" size="50" maxlength="50" /> <br /><br />
