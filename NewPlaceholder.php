...
<title>Opret ny Placeholder</title>
</head>
<body>
<div id="title">
...
<div id="content">
    <div id="colOne">
        <h2> Opret et ny placeholder</h2>
            <p> På denne side kan du oprette en ny placeholder</p>
            <div id="opret">
            <?php
               	echo "<form method=\"post\" action=\"../food/DB/NewPlaceholder_DB.php\">\n";
               	echo "<p>\n";
               	echo "<label><h3>Placeholder-navn</h3></label><br />\n";
               	echo "<input name=\"Placeholder\" type=\"text\" size=\"50\" maxlength=\"50\" /> <br /><br />\n";
               	echo "<label><h3>Placeholder-beskrivelse</h3></label><br />\n";
                echo"<textarea name=\"PlaceholderContent\" cols=\"50\" rows=\"15\"></textarea><br /> <br />";
          		echo "<input type=\"submit\" id=\"opret-submit\" value=\"Opret\" />\n";
                echo "<input name=\"Reset\" id=\"opret-reset\" type=\"Reset\" />\n";
                echo "</p>\n";
                echo "</form>\n";
				echo "<br/><br/>\n";
				echo" Eksisterende placeholders<ul>";
				while($row = mysqli_fetch_assoc($place))
					{
						echo "<li>".$row['Placeholder']."</li>";
					}
				echo"</ul>";
			?>
           </div>
