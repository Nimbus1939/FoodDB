...
$link = OpenDB();
$Quser = "Select * FROM Users ORDER BY UserAlias DESC";
...
<div id="content">
    <div id="colOne">
		...
		<?php
            while($row = mysqli_fetch_assoc($user)) //En while der kører alle rækker igennem
            {
            echo "<LI>".$row['UserAlias']."</LI>\n";
            }
        ?>
	</div>
	<div id="colTwo">
